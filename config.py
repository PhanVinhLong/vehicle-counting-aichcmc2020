detector = {
	...
	'detector-faster-train-1kiter': {
		'type': 'detectron',
		'classesmap': [[0, 1], [2], [3, 4], [5, 6, 7]],
		'classnames': ['1','2','3','4'],
		'originclassnames': ['bicycle','motorcycle','car','van','bus','truck','container','fire truck'],
		'cfgfile': 'detectron2/configs/COCO-Detection/faster_rcnn_R_101_FPN_3x.yaml',
		'weightfile': 'detectron2/model/model_0004799.pth',
		'batchsize': 20,
		'confidencethreshold': 0.5
	},
		'detector-faster-train-18kiter': {
		'type': 'detectron',
		'classesmap': [[0],[1],[2],[3]],
		'classnames': ['1','2','3','4'],
		'originclassnames': ['loai 1', 'loai 2', 'loai 3', 'loai 4', 'loai 5'],
		'cfgfile': 'detectron2/configs/COCO-Detection/faster_rcnn_R_101_FPN_3x.yaml',
		'weightfile': 'detectron2/model/model_0018799.pth',
		'batchsize': 20,
		'confidencethreshold': 0.5
	}
}
...
config = {
	'detector': detector['detector-faster-train-1kiter'],
	'tracker': {
